            ...
            <div class="card-body">
                ...
                <form id="member_form" name="member_form" onsubmit="checkForm(); return false;" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" aria-describedby="emailHelp" name="email" value="<?= htmlentities($row['email']) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="id_number" name="id_number" value="<?= htmlentities($row['id_number']) ?>">
                        <small class="form-text error_msg"></small>
                    </div>

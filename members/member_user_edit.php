...
<div class="container mr-5">
    <button type="button" style="background-color:<?= $page_name == 'member_user_list' ? '#86A697' : '#ffffff' ?> ;
           border-color:<?= $page_name == 'member_user_list' ? '#ffffff' : '#86A697' ?>;" class="btn mt-1">
        <a href="member_user_list.php" style="color:<?= $page_name == 'member_list' ? '#ffffff' : '#86A697' ?>">會員列表</a></button>
    <button type="button" style="background-color:<?= $page_name == 'member_user_edit' ? '#86A697' : '#ffffff' ?> ;
           border-color:<?= $page_name == 'member_user_edit' ? '#ffffff' : '#86A697' ?>;" class="btn mt-1">
        <a href="#" style=" color:<?= $page_name == 'member_user_edit' ? '#ffffff' : '#86A697' ?>">編輯</a></button>
    <div class="row mt-2">
        <div class="card">
            <div class="card-body">

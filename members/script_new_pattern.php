<script>
    ...
    // const _gender = document.getElementById('RadioMale');
    // const aaa = _gender("div > div"); //aaa
    // const gender_form = document.querySelectorAll(".aaa>small");
    ...
    function checkForm() {
        ...
        // if (_gender.value == 1) {
        //     isPass = false;
        //     _gender_form.style.color = 'red';
        //     _gender_form.innerHTML = '請選擇';
        // }


        if (isPass) {
            const fd = new FormData(document.member_form);
            fetch('../members/member_new_api.php', {
                    method: 'POST',
                    body: fd
                })
                .then(r => r.json())

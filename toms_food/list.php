...
<link rel="stylesheet" href="../../PHP_Project/product_css/list.css">
<style>
    .list {
        color: #fff;
...
<div class="concon">
    ...
    <div class="nvb-flex conconcon">
        ...
        <a class="astyle list" href="list.php">資料列表</a>
        <a class="astyle" href="inser.php">新增資料</a>
...
<script>
    ...
    if (<?= !isset($_GET['search']) ?>) hashHandler(); //頁面一進來 直接呼叫 
    ...
    const tableRowTpl = (obj) => {
        ...
        return `
                    ...
                    <td>${obj.expried}</td>
                    <td>${obj.firm}</td>
                    <td><a href="edit.php?sid=${obj.sid}"><i class="fas fa-edit editcolor"></i></a></td>
                    </tr>
    ...
    function showDataFromApi(obj) {
        ...
        let ptr = '';
        if (obj.totalRows == 0) {
            str = '<span class="no-data">查無資料</span>'
        ...
        console.log('obj.totalrows', str)



        document.querySelector('.pagination').innerHTML = ptr;
